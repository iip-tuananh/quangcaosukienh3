...
<div class="right-widgets mini-widgets">
    <div class="soc-ico show-on-desktop in-menu-first-switch in-menu-second-switch custom-bg disabled-border border-off  hover-disabled-border  hover-border-off"><a title="Facebook page opens in new window" href="{{$setting->facebook}}" target="_blank" class="facebook"><span class="soc-font-icon"></span><span class="screen-reader-text">Facebook page opens in new window</span></a><a title="Twitter page opens in new window" href="javascript:;" target="_blank" class="twitter"><span class="soc-font-icon"></span><span class="screen-reader-text">Twitter page opens in new window</span></a><a title="Linkedin page opens in new window" href="javascript:;" target="_blank" class="linkedin"><span class="soc-font-icon"></span><span class="screen-reader-text">Linkedin page opens in new window</span></a><a title="Skype page opens in new window" href="skype:quangcaoduckien?chat" target="_blank" class="skype"><span class="soc-font-icon"></span><span class="screen-reader-text">Skype page opens in new window</span></a><a title="Tumblr page opens in new window" href="javascript:;" target="_blank" class="tumbler"><span class="soc-font-icon"></span><span class="screen-reader-text">Tumblr page opens in new window</span></a><a title="Pinterest page opens in new window" href="javascript:;" target="_blank" class="pinterest"><span class="soc-font-icon"></span><span class="screen-reader-text">Pinterest page opens in new window</span></a><a title="Reddit page opens in new window" href="javascript:;" target="_blank" class="reddit"><span class="soc-font-icon"></span><span class="screen-reader-text">Reddit page opens in new window</span></a><a title="YouTube page opens in new window" href="javascript:;" target="_blank" class="you-tube"><span class="soc-font-icon"></span><span class="screen-reader-text">YouTube page opens in new window</span></a></div>
</div>
</div>
...
<div class="branding">
    ...
    <div class="mini-widgets">
        <div class="text-area show-on-desktop hide-on-first-switch hide-on-second-switch">
            <p><img style="float: right;" src="https://duckienad.com/wp-content/uploads/2018/08/phone_RIGHT-3.png" alt="Năng lực làm biển quảng cáo hàng đầu" width="277" height="80"  title="Năng lực làm biển quảng cáo hàng đầu"></p>
        </div>
    </div>
</div>
